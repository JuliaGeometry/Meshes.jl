...
@testitem "AdaptiveSampling" setup = [Setup] begin
  ...
  ps = sample(geom, method)
  ts = cart.([
    (0.0, 0.0),
    (0.08838834764831843, 0.08838834764831845),
    (0.25, 1.5308084989341915e-17),
    (0.26516504294495535, -0.2651650429449553),
    (6.123233995736766e-17, -0.5),
    (-0.44194173824159216, -0.44194173824159233),
    (-0.75, -1.3777276490407724e-16),
    (-0.6187184335382292, 0.618718433538229),
  ...
  # 2D Bezier curve
  geom = BezierCurve((0.,0.), (0.3, 0.7), (1.,0.), (1.,1.))
  ps = sample(geom, method)
  ts = cart.([
    (0.0, 0.0),
    (0.0606689453125, 0.1156005859375),
    (0.1291015625, 0.20292968749999998),
    (0.28281249999999997, 0.3109375),
    (0.6125, 0.38749999999999996),
    (0.7626953125, 0.4287109375),
    (0.8859375, 0.5203125),
    (0.9693359374999999, 0.6986328125000001),
  ...
  # 3D parameterized curve
  geom = ParametrizedCurve((t -> Point((sin(t * 2π) * t, cos(t * 2π) * t, t^2))), (0, 1))
  ps = sample(geom, method)
  ts = cart.([
    (0.0, 0.0, 0.0),
    (0.08838834764831843, 0.08838834764831845, 0.015625),
    (0.25, 1.5308084989341915e-17, 0.0625),
    (0.26516504294495535, -0.2651650429449553, 0.140625),
    (6.123233995736766e-17, -0.5, 0.25),
    (-0.44194173824159216, -0.44194173824159233, 0.390625),
    (-0.75, -1.3777276490407724e-16, 0.5625),
    (-0.6187184335382292, 0.618718433538229, 0.765625),
  ...
  # 3D Bezier curve
  geom = BezierCurve((0.,0., 0.), (0.3, 0.7, 0.5), (1.,0., 1.), (1.,1., 1.))
  ps = sample(geom, method)
  ts = cart.([
    (0.0, 0.0, 0.0),
    (0.1291015625, 0.20292968749999998, 0.1865234375),
    (0.28281249999999997, 0.3109375, 0.3671875),
    (0.6125, 0.38749999999999996, 0.6875),
    (0.7626953125, 0.4287109375, 0.8154296875),
    (0.8859375, 0.5203125, 0.9140625),
    (0.9334228515625, 0.5963623046875001, 0.9505615234375),
    (0.9693359374999999, 0.6986328125000001, 0.9775390625),
