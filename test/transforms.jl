@testset "Transforms" begin
  ...
  @testset "FlatCoords" begin
    @test !isaffine(FlatCoords())
    @test !TB.isrevertible(FlatCoords())
    @test !TB.isinvertible(FlatCoords())
    ...
    f = FlatCoords()
    g = Point(GeocentricLatLon(T(30), T(60)))
    r, c = TB.apply(f, g)
    @test r == Point(Cartesian{WGS84Latest}(T(30), T(60)))

    f = FlatCoords()
    g = Point(AuthalicLatLon(T(30), T(60)))
    r, c = TB.apply(f, g)
    @test r == Point(Cartesian{WGS84Latest}(T(30), T(60)))
    ...
    r, c = TB.apply(f, g)
    @test r == Point(Cartesian{WGS84Latest}(T(1), T(1)))
    ...
    f = FlatCoords()
    g = Rope(Point(Polar(T(0), T(0))), Point(Polar(T(1), T(0))), Point(Polar(T(1), T(π / 2))))
    r, c = TB.apply(f, g)
    @test r ≈ Rope(point(0, 0), point(1, 0), point(0, 1))

    f = FlatCoords()
    g = Ring(Point(Polar(T(0), T(0))), Point(Polar(T(1), T(0))), Point(Polar(T(1), T(π / 2))))
    r, c = TB.apply(f, g)
    @test r ≈ Ring(point(0, 0), point(1, 0), point(0, 1))
    ...
    f = FlatCoords()
    g = Triangle(Point(Polar(T(0), T(0))), Point(Polar(T(1), T(0))), Point(Polar(T(1), T(π / 2))))
    r, c = TB.apply(f, g)
    @test r ≈ Triangle(point(0, 0), point(1, 0), point(0, 1))
  end
