@testset "Transforms" begin
  ...
  @testset "Shadow" begin
    ...
    @test TB.parameters(Shadow(:xy)) == (; plane=(:x, :y))
    @test TB.parameters(Shadow(:yx)) == (; plane=(:x, :y))
    @test TB.parameters(Shadow(:xz)) == (; plane=(:x, :z))
    @test TB.parameters(Shadow(:yz)) == (; plane=(:y, :z))
