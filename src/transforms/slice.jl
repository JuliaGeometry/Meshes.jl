...
_sliceinds(g::RegularGrid{🌐,<:LatLon}, b::Box{🌐}) = cartesianrange(g, b)
_sliceinds(g::RectilinearGrid{🌐,<:LatLon}, b::Box{🌐}) = cartesianrange(g, b)
_sliceinds(g::Grid{🌐}, b::Box{🌐}) = indices(g, b)
