...
firstoffset(s::Sphere) = _firstoffset(s, Val(embeddim(s)))
lastoffset(s::Sphere) = _lastoffset(s, Val(embeddim(s)))
extrapoints(s::Sphere, sz) = _extrapoints(s, Val(embeddim(s)), sz)
