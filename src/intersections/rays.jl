...
=#
function intersection(f::Function, r1::Ray{3,T}, r2::Ray{3,T}) where {T}
  a, b = r1(0), r1(1)
  c, d = r2(0), r2(1)
...
6. do not overlap nor intersect (NoIntersection)
=#
function intersection(f::Function, r1::Ray{2,T}, r2::Ray{2,T}) where {T}
    a, b = r1(0), r1(1)
    c, d = r2(0), r2(1)
...
function intersectpoint(r1::Ray, r2::Ray)
    return intersectpoint(Line(r1(0), r1(1)), Line(r2(0), r2(1)))
end
