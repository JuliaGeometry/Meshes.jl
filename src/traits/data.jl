...
function (D::Type{<:Data})(geotable)
  ...
  return constructor(D)(domain, values)
end
...
function Tables.schema(rows::DataRows)
  ...
  return Tables.Schema((names..., :geometry), (types..., geomtype))
end
...
function Base.getindex(data::Data, inds::AbstractVector{Int}, vars::AbstractVector{Symbol})
  ...
  newtab = Tables.materializer(tab)((; pairs...))
  newval = Dict(paramdim(newdom) => newtab)
  return constructor(data)(newdom, newval)
end

function Base.getindex(data::Data, inds::AbstractVector{Int}, var::Symbol)
  return getproperty(view(data, inds), var)
end
...
function Base.getindex(data::Data, ::Colon, vars::AbstractVector{Symbol})
  ...
  return constructor(data)(dom, newval)
end

Base.getindex(data::Data, ::Colon, var::Symbol) = getproperty(data, var)

function Base.getindex(data::Data, inds, vars::AbstractVector{<:AbstractString})
  return getindex(data, inds, Symbol.(vars))
end
...
function Base.getindex(data::Data, inds, var::Regex)
  ...
  return getindex(data, inds, snames)
end
...
function asarray(data::Data, var::Symbol)
  ...
  return hassize ? reshape(dataval, size(D)) : dataval
end
