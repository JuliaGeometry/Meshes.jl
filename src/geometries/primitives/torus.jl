...
Base.isapprox(t₁::Torus, t₂::Torus; kwargs...) =
  isapprox(t₁.center, t₂.center; kwargs...) &&
  isapprox(t₁.normal, t₂.normal; kwargs...) &&
  isapprox(t₁.major, t₂.major; kwargs...) &&
  isapprox(t₁.minor, t₂.minor; kwargs...)
